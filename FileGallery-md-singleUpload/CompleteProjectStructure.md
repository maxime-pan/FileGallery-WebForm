...
6. **Default.aspx.designer.cs** - Main page designer (see artifact)
7. **Login.aspx** - Login page (see artifact)
8. **Login.aspx.cs** - Login code (see artifact)
9. **Login.aspx.designer.cs** - Login designer (see artifact)
10. **Admin.aspx** - Admin page (see artifact)
11. **Admin.aspx.cs** - Admin code (see artifact)
12. **Admin.aspx.designer.cs** - Admin designer (see artifact)
13. **Upload.aspx** - Upload page (see artifact)
14. **Upload.aspx.cs** - Upload code (see artifact)
15. **Upload.aspx.designer.cs** - Upload designer (see artifact)

### Properties Folder:
16. **Properties/AssemblyInfo.cs** - Assembly info (see artifact)

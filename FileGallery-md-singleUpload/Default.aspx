    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="right-column">
                ...
                <asp:Panel ID="MarkdownPanel" runat="server" CssClass="markdown-section" Visible="false">
    ...
    <script>
        function previewFile(path, ext, name) {
            ...
            if (['.jpg', '.jpeg', '.png', '.gif', '.bmp'].includes(ext)) {
                container.innerHTML = '<img src="' + path + '" alt="' + name + '" onerror="handleImageError(this)">';
